...
public:
    PurePursuit(){
        ...
        drive_pub = n.advertise<ackermann_msgs::AckermannDriveStamped>("/vesc/high_level/ackermann_cmd_mux/input/nav_0", 1000);
        point_sub = n.subscribe("/path", 10, &PurePursuit::pathCallBack, this);
        pose_sub = n.subscribe("/pf/pose/odom", 1000, &PurePursuit::poseCallBack, this);
    }
